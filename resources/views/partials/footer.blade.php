    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"><i class="fa fa-envelope me-3"></i>info@heavenleagueca.com</p>
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">Heaven-league</a>, Tous droits réservés.
                    Conçu par <a class="border-bottom" href="www.linkedin.com/in/sidik-slims-80698b67">Sidik
                        Slims</a>
                </div>
